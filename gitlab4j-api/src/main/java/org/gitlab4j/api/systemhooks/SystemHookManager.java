...
public class SystemHookManager implements HookManager {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(SystemHookManager.class.getName());
    ...
    public SystemHookEvent handleRequest(HttpServletRequest request) throws GitLabApiException {
        ...
        try {
            ...
            if (LOGGER.isTraceEnabled()) {
                LOGGER.trace(HttpRequestUtils.getShortRequestDump("System Hook", true, request));
        ...
        try {
            ...
            if (LOGGER.isTraceEnabled()) {
                LOGGER.trace(event.getEventName() + "\n" + jacksonJson.marshal(event) + "\n");
            }
