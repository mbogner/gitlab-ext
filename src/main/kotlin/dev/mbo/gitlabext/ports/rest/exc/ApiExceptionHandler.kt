package dev.mbo.gitlabext.ports.rest.exc

import dev.mbo.gitlabext.ports.rest.model.ErrorArgumentDto
import dev.mbo.gitlabext.ports.rest.model.ErrorDto
import dev.mbo.gitlabext.service.exc.ApiErrorCode
import dev.mbo.gitlabext.service.exc.ErrorCode
import dev.mbo.gitlabext.service.exc.ServiceException
    ...
    private fun createErrorDto(
        ...
        if (null != args) {
            for (key in args.keys) {
                ...
                errorArgs.add(
                    ErrorArgumentDto(key, value?.toString(), type)
                )
            }
        }
        return ErrorDto(
